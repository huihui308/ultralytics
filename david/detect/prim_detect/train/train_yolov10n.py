...
model = YOLO("runs/detect/class11-wangjing-yizhuang/weights/best.pt")

# Train the model
model.train(data="david/detect/prim_detect/datasets/yolov10_class11.yaml", epochs=300, imgsz=640, batch=48, device=[0,1])
